...
const ChatDetailScreen = () => {
    ...
    return (
        <SafeAreaView style={[styles.container, Platform.OS === 'web' && { height: '100vh' }]} edges={['top']}>
                    ...
                    {Platform.OS === 'web' ? (
                        ...
                        <>
                            ...
                            <FlatList
                                ...
                                showsVerticalScrollIndicator={false}
                                onContentSizeChange={() => {
                                    // Scroll automático al final cuando cambia el contenido
                            ...
                            >
                                <View style={[
                                    styles.inputContainer,
                                    { bottom: Platform.OS === 'ios' ? keyboardHeight : insets.bottom || 0 }
                                ]}>
                                    <TouchableOpacity
                                        style={styles.actionButton}
                                        activeOpacity={0.7}

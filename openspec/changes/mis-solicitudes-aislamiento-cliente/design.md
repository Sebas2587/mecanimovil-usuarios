...
3. **App**: `obtenerMisSolicitudes` → `GET .../mis-solicitudes/` (respuesta paginada como `list`); `extraerFeaturesDeRespuesta` soporta `FeatureCollection` en raíz o en `results`.
